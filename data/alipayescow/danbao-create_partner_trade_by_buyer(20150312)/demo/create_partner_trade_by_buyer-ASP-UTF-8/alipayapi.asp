...
'/////////////////////请求参数/////////////////////
        ...
        '必填，不能修改
        '服务器异步通知页面路径
        notify_url = "http://商户网关地址/create_partner_trade_by_buyer-ASP-UTF-8/notify_url.asp"
        '需http://格式的完整路径，不能加?id=123这类自定义参数

        '页面跳转同步通知页面路径
        return_url = "http://商户网关地址/create_partner_trade_by_buyer-ASP-UTF-8/return_url.asp"
