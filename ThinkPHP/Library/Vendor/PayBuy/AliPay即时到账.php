...
class AliPay{
	...
	public $orderid='';							//必填，订单id
	public $subject='';							//必填商品名称
	public $price='';							//必填，价格
	public $message='';							//订单描述
	public $show_url='';						//商品展示地址
	public $anti_key='';						//防钓鱼时间戳，若要使用请调用类文件submit中的query_timestamp函数
	public $exter_ip='';						//客户端IP地址，非局域网的外网IP地址，如：221.0.0.1
...
class AlipaySubmit {
	...
	function buildRequestForm($para_temp, $method, $button_name) {
        ...
        $sHtml = $sHtml.($button_name ? "<input type='submit' value='".$button_name."' style=\"\">" : '')."</form>";
